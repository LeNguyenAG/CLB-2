...
TRUNCATE TABLE player_valuation_results;
TRUNCATE TABLE player_valuation_batches;
...
TRUNCATE TABLE national_cup_results;
TRUNCATE TABLE national_cup_match_links;
TRUNCATE TABLE national_cup_matches;
TRUNCATE TABLE national_cup_rounds;
TRUNCATE TABLE national_cup_entries;
TRUNCATE TABLE national_cup_confederation_quotas;
TRUNCATE TABLE national_cup_profiles;
TRUNCATE TABLE national_competition_reward_rules;
